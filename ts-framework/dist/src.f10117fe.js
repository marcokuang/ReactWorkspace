...
function () {
  ...
  User.prototype.fetch = function () {
    ...
    var serverGetString = "http://localhost:3003/users/" + this.get("id");
    axios_1.default.get(serverGetString).then(function (response) {
  ...
  User.prototype.save = function () {
    ...
    if (id) {
      axios_1.default.put("http://localhost:3003/users/" + id, this.data);
    } else {
      axios_1.default.post("http://localhost:3003/users", this.data);
    }
  };
