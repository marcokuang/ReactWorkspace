...
var userForm = new UserForm_1.UserForm(document.getElementById("root"), user1);
setTimeout(function () {
  userForm.render();
}, 600);
},{"./views/UserForm":"src/views/UserForm.ts","./models/User":"src/models/User.ts"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
