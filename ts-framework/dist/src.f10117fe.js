...
function () {
  ...
  View.prototype.bindEvents = function (fragment) {
    ...
    var _loop_1 = function _loop_1(eventKey) {
      ...
      var _a = eventKey.split(":"),
          eventName = _a[0],
          selector = _a[1]; // for each of the elements, add event listeners accordingly
  ...
  View.prototype.render = function () {
    ...
    this.mapRegions(templateElement.content); // nesting process of the elements
...
function (_super) {
  ...
  function UserForm() {
    ...
    _this.onSetNameClick = function () {
      ...
      var input = _this.parent.querySelector("input"); // update the model
...
function () {
  function Attributes(data) {
    ...
    this.data = data; // K type can only be one of the keys of T
...
function () {
  ...
  ApiSync.prototype.fetch = function (id) {
    var serverGetString = this.rootUrl + "/" + id;
    return axios_1.default.get(serverGetString);
  };
...
var userEdit = new UserEdit_1.UserEdit(root, user1);
setTimeout(function () {
  userEdit.render();
  console.log(userEdit);
}, 600);
},{"./views/UserEdit":"src/views/UserEdit.ts","./models/User":"src/models/User.ts"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
