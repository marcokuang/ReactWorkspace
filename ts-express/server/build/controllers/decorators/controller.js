...
function controller(routePrefix) {
    return function (target) {
        ...
        for (var key in target.prototype) {
            ...
            if (path) {
                console.log(">>>", path, method, "middlewares.length: " + middlewares.length);
                router[method].apply(router, __spreadArrays(["" + routePrefix + path, validator], middlewares, [routeHandler]));
            }
        }
    };
}
